...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:self.avatarDecorationID forKey:@"avatarDecorationID"];
    [aCoder encodeInteger:self.discriminator forKey:@"discriminator"];
...
- (id)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        ...
        self.avatarDecorationID = [aDecoder decodeObjectForKey:@"avatarDecorationID"];
        self.discriminator   = [aDecoder decodeIntegerForKey:@"discriminator"];
